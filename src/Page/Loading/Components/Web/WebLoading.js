...
const WebLoading = () => {
  ...
  const TextListMust = [
    ...
    `지금부터 ${user}님의 답변 분석을 시작할게요.`,
    `${user}님의 답변을 확인하고 있어요.`,
    `${user}님의 답변을 분석중이에요.`,
  ];
  ...
  const TextListRandom = [
    ...
    `${user}님만의 독특한 브랜드 가치를 발굴하고 있어요.`,
    `${user}님의 장점을 브랜드 스토리에 통합하고 있어요.`,
    `시장 트렌드와 ${user}님의 브랜드를 매칭 중이에요.`,
    `${user}님의 브랜드가 돋보일 수 있는 전략을 수립하고 있어요.`,
    `${user}님의 브랜드를 잘 나타낼 수 있는 키워드를 생성하고 있어요.`,
    `${user}님의 브랜드가 강력한 영향력을 발휘할 수 있도록 준비 중이에요.`,
    "인상적인 브랜드 메시지를 작성 중이에요.",
    `${user}님의 브랜드에 알맞는 카드 디자인을 선택 중이에요.`,
    "브랜드 인지도를 높이기 위한 전략을 마련 중이에요.",
    `${user}님의 경험과 성과를 브랜드 스토리로 변환하고 있어요.`,
    "브랜드의 지속 가능한 성장을 위한 전략적 계획을 수립 중이에요.",
    `${user}님의 역량을 파악하는 중이에요.`,
    `${user}님의 브랜드가 목표 타겟에게 어떻게 인식될지 분석 중이에요.`,
    `타겟 청중 분석을 통해 ${user}님의 브랜드 포지셔닝을 최적화하고 있어요.`,
    `${user}님의 개인 경험을 브랜드 스토리로 전환하고 있어요.`,
    `글로벌 브랜드 트렌드를 분석하여 ${user}님의 브랜드를 조정하고 있어요.`,
    `${user}님의 브랜드 이야기를 위한 특별한 향신료를 찾아내는 중이에요.`,
    `${user}님의 브랜드 생성을 위해 소셜 미디어를 탐험 중이에요.`,
    `${user}님의 경험에서 숨겨진 보석같은 브랜드를 발굴하고 있어요.`,
    `${user}님의 브랜드를 빛나게 다듬고 있어요.`,
    "브랜드의 퍼즐 조각을 맞추며 완벽한 그림을 그리고 있어요.",
    `${user}님의 브랜드 정체성에 풍부한 색채를 더하고 있어요.`,
  ];
